...
const FooterHero: React.FC<FooterHeroProps> = ({
  ...
  return (
    <div
      className={`${image} text-center text-white w-screen h-[508px] flex flex-col justify-center items-center pb-24 lg:gap-24`}
    >
      ...
      <a
        className="text-base font-black lg:text-lg bg-[#D33F3F] text-white border-2 border-white w-[140px] lg:w-[240px] h-[61px] flex items-center justify-center"
